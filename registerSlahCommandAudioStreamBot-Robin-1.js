...
const commands = [
  ...
  new SlashCommandBuilder().setName("stop-robin-1").setDescription("Stop stream bot and leave the channel."),
...
const CLIENT_ID = (process.env.CLIENT_ROBIN_1_ID);
const GUILD_ID = (process.env.GUILD_ID_DARKNESS);

rest.put(Routes.applicationGuildCommands(CLIENT_ID, GUILD_ID_DARKNESS), { body: commands })
